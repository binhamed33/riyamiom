...
//
// الانصراف لا يُسجَّل إلا بضغط «تسجيل الانصراف»، والموظّف يُغلق المتصفّح
// ويمضي فيبقى سجلّه مفتوحاً بلا دقائق. يُقفَل هنا بوقت آخر نشاطٍ بشريٍّ
// معروفٍ له في يومه، لا بساعة تشغيل الأمر — ومَن لا أثرَ له يُترك.
...
// وقفلُ التزامن بمهلة: تشغيلٌ قُتل في نشرٍ كان يُبقي القفلَ فتُسكَت
// المسحاتُ حتى آخر الليل — والمسحةُ ثوانٍ، وهي آمنةُ التكرار.
Schedule::command('hr:close-attendance --cap')->hourly()->withoutOverlapping(10);
