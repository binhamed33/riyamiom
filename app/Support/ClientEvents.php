 ...
 *
 * ═══ ولماذا واحدٌ فقط مفعَّلٌ افتراضاً ═══
 *
 * لأنّ كلَّ رسالةٍ تُحاسَب عند المزوّد الرسمي، وكلَّ رسالةٍ غير
 * مرغوبة بلاغٌ محتمَل يُنزل تقييمَ رقم المكتب. فالمكتب يفتح ما
 * يريد بيده، ولا يُفتح له شيءٌ لم يطلبه.
 */
class ClientEvents
{
