...
class AiSettings
{
     ...
     *
     * ═══ ثم انقلب الترتيب بقرارٍ نصّي ═══
     *
     * «أريد أربط حسابي في جميع المواقع — لما يكتبون أي شيء للمساعد
     * كأنهم يكتبون لحسابي وهو يردّ عليهم». فالمركزيُّ — حسابُ صاحب
     * المنظومة في .env — هو الأوّل، ومفتاحُ المكتب إن وُضع احتياطٌ
     * يُلجأ إليه عند نفاد المركزي، لا العكس.
     *
     * والعزلُ باقٍ بحاله: المفتاحُ مشترَكٌ والمحادثاتُ ليست كذلك —
     * كلُّ مكتبٍ قاعدةٌ مستقلّة، وGoogle لا تصلها إلا نصوصُ الأسئلة
     * بلا هويّة مكتبٍ ولا موكّل.
     *
