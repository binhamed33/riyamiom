...
class SendingGuard
{
    ...
    public static function delayFor(WhatsAppMessage $message): ?int
    {
        ...
        //
        // ═══ ولا تُطبَّق على يدِ إنسان ═══
        //
        // الفجوةُ حارسٌ ضدّ الإرسال الآليّ المتتابع: نظامٌ يقذف عشرين
        // إشعاراً في دقيقة يُقرأ عند واتساب رشّاً فيُحظر الرقم. أمّا
        // محامٍ يكتب رسالتين متتاليتين في محادثةٍ مفتوحة فذاك السلوكُ
        // الطبيعيّ نفسُه الذي بُني عليه واتساب — لا ما يعاقب عليه.
        //
        // وكانت تُطبَّق عليه: يكتب الثانية فتُحجَز ستَّ عشرةَ ثانيةً
        // إلى أربعٍ وعشرين، والموكّلُ ينتظر والمحامي يظنّها أخفقت.
        // وأسوأُ منه أنّ آخِرَ صادرٍ يُقاس على **كلّ** المكتب: إشعارٌ
        // آليٌّ ذهب لموكّلٍ قبل ثانيةٍ كان يؤخّر ردَّ المحامي على
        // موكّلٍ آخرَ لا علاقةَ له به.
        //
        // والسقوفُ تبقى عليه كما هي: خمسَ عشرةَ في الساعة ومئةً في
        // اليوم تُمسك اليدَ التي تتحوّل قناةَ بثٍّ جماعيّ.
        $last = $byHuman ? null : WhatsAppMessage::where('direction', WhatsAppMessage::OUT)
