...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h2 class="text-2xl font-bold text-white">{{ __('app.sessions') }}</h2>
    ...
    <form method="GET" action="{{ route('sessions.index') }}" class="bg-navy rounded-xl border border-white/10 p-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                <label class="block text-sm font-medium text-white/70 mb-1">{{ __('app.from_date') }}</label>
            ...
            <div>
                <label class="block text-sm font-medium text-white/70 mb-1">{{ __('app.to_date') }}</label>
                    ...
                    <tr class="hover:bg-white/5 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-1">
                                <a href="{{ route('sessions.show', $session) }}" class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-blue-500/10 text-blue-400 hover:bg-blue-500/20 transition-colors" title="{{ __('app.view') }}">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z"/><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                                </a>
                                <a href="{{ route('sessions.edit', $session) }}" class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-[#C9A55A]/10 text-[#C9A55A] hover:bg-[#C9A55A]/20 transition-colors" title="{{ __('app.edit') }}">
