        ...
        <div class="flex flex-col gap-3">
            @php
                $faqs = [
                    ...
                    ['q' => 'ما مدى أمان بيانات مكتبنا على LexPro؟', 'a' => 'بياناتك مشفّرة أثناء النقل والتخزين، مع فصل كامل بين بيانات كل مكتب، صلاحيات دقيقة حسب الأدوار، سجل تدقيق لكل عملية، وتحقق ثنائي MFA للمستخدمين — مع نسخ احتياطي يومي مشفّر.'],
                    ...
                    ['q' => 'هل أحتاج إلى أجهزة أو بنية تحتية خاصة؟', 'a' => 'لا — LexPro خدمة سحابية بالكامل تعمل من أي متصفح على الحاسوب أو الجوال، ولا تحتاج تثبيت برامج أو صيانة. التحديثات والنسخ الاحتياطي تتم تلقائيًا.'],
