...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-gray-900">{{ __('app.page_add_task') }}</h2>
        <a href="{{ route('tasks.index') }}" aria-label="{{ __('app.back') }}" class="text-gray-500 hover:text-gray-800 transition-colors">
