...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-3xl font-bold text-gold-dark">{{ __('app.page_edit_client') }}</h1>
        ...
        <div>
            ...
            <div class="flex items-center gap-6">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="radio" name="type" value="individual" {{ old('type', $client->type) === 'individual' ? 'checked' : '' }} class="w-4 h-4 text-gold-dark bg-white border-gray-300 focus:ring-gold-dark" required>
                    <span class="text-gray-700">{{ __('app.individual') }}</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="radio" name="type" value="company" {{ old('type', $client->type) === 'company' ? 'checked' : '' }} class="w-4 h-4 text-gold-dark bg-white border-gray-300 focus:ring-gold-dark">
