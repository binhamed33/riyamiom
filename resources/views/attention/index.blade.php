...
<div class="space-y-6" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    ...
    <div class="flex items-center justify-between">
        ...
        <button type="button" onclick="window.location.reload()" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-amber-200 bg-white text-sm font-medium text-amber-700 hover:bg-amber-50 transition">
