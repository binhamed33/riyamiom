...
<head>
    ...
    <title>بوابة الموكل - مكتب الرياضي للمحاماة</title>
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-xl border border-amber-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-l from-amber-600 to-amber-700 px-6 py-8 text-center">
                ...
                <h1 class="text-2xl font-bold text-white">مكتب الرياضي للمحاماة</h1>
                <p class="text-amber-200 text-sm mt-1">بوابة الموكل - الاستعلام عن القضايا</p>
            </div>
            ...
            <div class="px-6 pb-6 text-center">
                <p class="text-xs text-gray-400">
                    سيتم عرض القضايا المسجلة باسمك فقط
                </p>
            </div>
        </div>
    </div>
