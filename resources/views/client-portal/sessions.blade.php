...
<div class="space-y-6" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    ...
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-amber-600">{{ __('app.my_sessions') }}</h1>
    </div>
            ...
            <table class="w-full text-sm text-right">
                <thead>
                    <tr class="border-b border-gray-200">
                        <th class="px-4 py-3 text-amber-600 font-bold whitespace-nowrap">{{ __('app.date') }}</th>
                        <th class="px-4 py-3 text-amber-600 font-bold whitespace-nowrap">{{ __('app.location') }}</th>
                        ...
                        <th class="px-4 py-3 text-amber-600 font-bold whitespace-nowrap">{{ __('app.notes') }}</th>
                    </tr>
                </thead>
