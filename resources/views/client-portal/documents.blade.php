...
<div class="space-y-6" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    ...
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gold-dark">{{ __('app.my_documents') }}</h1>
    </div>
            ...
            <table class="w-full text-sm text-right">
                <thead>
                    <tr class="border-b border-gray-200">
                        ...
                        <th class="px-4 py-3 text-gold-dark font-bold whitespace-nowrap">{{ __('app.type') }}</th>
                        <th class="px-4 py-3 text-gold-dark font-bold whitespace-nowrap">{{ __('app.table_size') }}</th>
                        <th class="px-4 py-3 text-gold-dark font-bold whitespace-nowrap">{{ __('app.case') }}</th>
                        <th class="px-4 py-3 text-gold-dark font-bold whitespace-nowrap">{{ __('app.access_level') }}</th>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 rounded bg-gold/12 flex items-center justify-center flex-shrink-0">
