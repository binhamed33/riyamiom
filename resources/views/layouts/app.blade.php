...
[data-theme="dark"] .border-gray-200, [data-theme="dark"] .border-gray-100, [data-theme="dark"] .divide-gray-100, [data-theme="dark"] .divide-gray-200 { border-color: #252D3D !important; }
        ...
        /* ═══ جدولٌ أعمدتُه في الوسط ═══

           الأرقامُ والتواريخُ تُقرأ بنظرةٍ واحدة حين تقف فوق بعضها، ولا
           تقف إلا بالتوسيط. وكان كلُّ عمودٍ إلى حافّته وعنوانُه فوقه في
           مكانٍ آخر، فتبحث العينُ عن العمود بدل أن تقرأه.

           ولماذا قاعدةٌ واحدةٌ لا صنفٌ على كلّ خليّة: عمودُ «المدة» أُصلح
           مرّةً في جدولٍ وبقي في اثنين، لأنّ التنسيقَ كان مكتوباً في كلّ
           خليّةٍ على حِدة. فمن كتبه في موضعٍ نسيه في موضعين.

           و‎:where يجعل ثقلَ القاعدة صفراً، فأيُّ صنفٍ على الخليّة نفسِها
           يغلبها — وهكذا يبقى الاستثناء ممكناً بلا !important: الاسمُ
           والسببُ ونصٌّ حرٌّ تُكتب text-start فتُقرأ من مبدئها. */
        :where(.tbl-centred) :where(th, td) {
            text-align: center;
        }

        /* والأرقامُ بعرضٍ ثابت: «١» أضيقُ من «٨» في الخطّ الافتراضيّ،
           فيتذبذب مركزُ النصّ من صفٍّ إلى صفّ ويبدو العمودُ مهتزّاً وهو
           متوسّطٌ فعلاً. */
        .tbl-centred td,
        .tbl-centred th {
