            ...
            <div class="w-full max-w-md anim-up d3">
                <div class="card-luxury rounded-3xl overflow-hidden relative">
                    ...
                    <div class="px-10 pt-12 pb-8">
                        ...
                        <div class="flex items-center gap-3 my-6 anim-up d7">
                            <div class="h-px flex-1 bg-gray-200"></div>
                            <span class="text-xs text-gray-400">أو</span>
                            <div class="h-px flex-1 bg-gray-200"></div>
                        </div>

                        <form method="POST" action="{{ route('guest.login') }}" class="anim-up d8">
                            @csrf
                            <button type="submit"
                                class="w-full py-3.5 px-6 rounded-2xl border-2 border-dashed border-amber-300/70 text-amber-700 hover:bg-amber-50 hover:border-amber-400 transition-all duration-300 text-sm font-semibold flex items-center justify-center gap-2.5" style="font-family:'Cairo',sans-serif;">
                                <svg class="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z"/><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                                تصفح الموقع كضيف — بدون بيانات
                            </button>
                        </form>
                    </div>
