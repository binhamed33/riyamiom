        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    @php
                        $waMsgShow = urlencode("يسر **شركة حمد الريامي للمحاماة (شركة مدنية للمحاماة)** أن تضع بين أيديكم خدمة **متابعة القضايا إلكترونياً**، وذلك حرصاً منا على تعزيز جودة الخدمات القانونية، وتوفير تجربة أكثر سهولة وشفافية لموكلينا الكرام.
...
نعتز بثقتكم، ونسعى دائماً إلى تقديم خدمات قانونية احترافية بأعلى معايير الجودة.");
                        $waPhoneShow = ltrim($case->client->phone, '+');
                    @endphp
                    <a href="https://wa.me/{{ $waPhoneShow }}?text={{ $waMsgShow }}" target="_blank" class="inline-flex items-center justify-center w-6 h-6 rounded-lg bg-green-100 text-green-700 hover:bg-green-200 transition-colors" title="إرسال رابط المتابعة عبر واتساب">
