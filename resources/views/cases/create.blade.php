        ...
        <div class="bg-white rounded-xl border border-gold/15 p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="tel" name="opponent_phone" id="opponent_phone" value="{{ old('opponent_phone') }}" data-phone inputmode="tel" autocomplete="tel" maxlength="20" dir="ltr"
                ...
                <div>
                    ...
                    <input type="email" name="opponent_email" id="opponent_email" value="{{ old('opponent_email') }}" dir="ltr"
                ...
                <div>
                    ...
                    <select name="opponent_role" id="opponent_role"
                        ...
                        @foreach (\App\Models\LegalCase::OPPONENT_ROLES as $value => $label)
                            <option value="{{ $value }}" @selected(old('opponent_role') === $value)>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                <div>
                    ...
                    <select name="opponent_type" id="opponent_type"
                        ...
                        @foreach (\App\Models\LegalCase::OPPONENT_TYPES as $value => $label)
                            <option value="{{ $value }}" @selected(old('opponent_type') === $value)>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="md:col-span-2">
                    ...
                    <textarea name="opponent_notes" id="opponent_notes" rows="3" maxlength="2000"
                        class="w-full rounded-lg bg-white border border-gray-200 px-4 py-2.5 text-gray-900 text-sm focus:ring-2 focus:ring-gold-dark focus:border-gold/40">{{ old('opponent_notes') }}</textarea>
