    ...
    <form action="{{ route('cases.update', $case->id) }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-xl border border-gold/15 p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="tel" name="opponent_phone" id="opponent_phone" value="{{ old('opponent_phone', $case->opponent_phone) }}" data-phone inputmode="tel" autocomplete="tel" maxlength="20" placeholder="9123 4567 أو +968 9123 4567"
        ...
        <div class="bg-white rounded-xl border border-gold/15 p-6 space-y-4" x-data="sessionsManager()">
            ...
            <template x-for="(s, i) in sessions" :key="i">
                <div class="border border-gray-200 rounded-xl p-4 space-y-3 relative" x-show="!s._hidden">
                    ...
                    <input type="hidden" :name="'sessions['+i+'][id]'" x-model="s.id">
                    <input type="hidden" :name="'sessions['+i+'][delete]'" x-model="s.delete">
        ...
        function sessionsManager() {
            return {
                sessions: @json($existingSessions),
                addSession() {
                    this.sessions.push({ id: '', date: '', location: '', status: 'upcoming', report: '', notes: '', delete: '' });
                },
                removeSession(i) {
