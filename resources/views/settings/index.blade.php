...
@php
    ...
    $secCards = array_values(array_filter([
        ...
        // المواعيدُ والحضورُ للمطوّر وحدَه: طلبُ صاحب المنصّة. والقيمُ
        // المحفوظةُ تعمل كما هي — أُخفي البابُ لا ما خلفه.
        $isDev ? ['key' => 'appointments', 'title' => 'المواعيد', 'desc' => 'أيامُ العمل وساعاتُه وطولُ الموعد ووقتُ التذكير',
        ...
        $isDev ? ['key' => 'attendance', 'title' => 'الحضور والصيانة', 'desc' => 'تسجيلُ الحضور التلقائيّ وسقفُ المناوبة ونصُّ صفحة الصيانة',
         'icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'] : null,
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
            ...
            <label class="flex items-start gap-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50 cursor-pointer mb-5">
                ...
                <span>
                    ...
                    <span class="block text-xs text-gray-500 mt-0.5">
                        معطَّلٌ افتراضاً: الانصراف يُسجَّل بضغط زرّ «تسجيل الانصراف» وحده —
                        والخروجُ من النظام لا يُنهي اليوم — ومن نسيه أقفله سقفُ المناوبة
                        موسوماً. فعّله إن أردت أن يُقفل
            ...
            <div class="mb-5">
                ...
                <p class="text-xs text-gray-500 mt-1.5 leading-relaxed">
                    ...
                    ولا يُقفل على من ما زال على شاشته: يُترك حتى يغيب ساعة، وإن جاوز السقفَ
                    وهو يعمل أُقفل على آخر ما رآه الخادم لا على السقف. ومن أُقفل يومُه وهو
                    في دوامه يضغط «استئناف الدوام» فيُفتح ويُحفظ ما سبق.
                </p>
            </div>
