...
<div class="max-w-4xl mx-auto space-y-6" dir="rtl">
    ...
    <div class="flex items-center gap-3">
        <h1 class="text-2xl font-bold text-gold flex items-center gap-2">
    ...
    {{-- Description --}}
    <div class="bg-navy rounded-xl border border-gold/20 p-5">
        <p class="text-white/60 text-sm">{{ __('app.reports_desc') }}</p>
        <p class="text-white/40 text-xs mt-2">{{ __('app.reports_hint') }}</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {{-- Cases --}}
        <div class="bg-navy rounded-xl border border-gold/20 p-5 hover:border-gold/40 transition-colors">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div>
                    <p class="text-white font-bold text-sm">{{ __('app.cases') }}</p>
                    <p class="text-white/40 text-xs">{{ $counts['cases'] }} {{ __('app.record') }}</p>
                </div>
            </div>
        ...
        <div class="bg-navy rounded-xl border border-gold/20 p-5 hover:border-gold/40 transition-colors">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div>
                    <p class="text-white font-bold text-sm">{{ __('app.sessions') }}</p>
                    <p class="text-white/40 text-xs">{{ $counts['sessions'] }} {{ __('app.record') }}</p>
                </div>
            </div>
        ...
        <div class="bg-navy rounded-xl border border-gold/20 p-5 hover:border-gold/40 transition-colors">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div>
                    <p class="text-white font-bold text-sm">{{ __('app.tasks') }}</p>
                    <p class="text-white/40 text-xs">{{ $counts['tasks'] }} {{ __('app.record') }}</p>
                </div>
            </div>
        ...
        <div class="bg-navy rounded-xl border border-gold/20 p-5 hover:border-gold/40 transition-colors">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div>
                    <p class="text-white font-bold text-sm">{{ __('app.clients') }}</p>
                    <p class="text-white/40 text-xs">{{ $counts['clients'] }} {{ __('app.record') }}</p>
                </div>
            </div>
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                <div class="w-12 h-12 rounded-lg bg-gold/20 flex items-center justify-center">
                    <svg class="w-6 h-6 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
                </div>
                <div>
                    <p class="text-white font-bold">{{ __('app.export_all') }}</p>
                    <p class="text-white/50 text-xs">{{ __('app.export_all_desc') }}</p>
                </div>
            </div>
            <a href="{{ route('export.all') }}" class="bg-gold hover:bg-gold-dark text-navy px-6 py-2.5 rounded-lg font-semibold transition-colors text-sm">
                {{ __('app.export_excel') }}
            </a>
        </div>
    </div>
