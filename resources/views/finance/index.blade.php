                            ...
                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        @if($isFinAdmin)<form method="POST" action="{{ route('finance.invoices.destroy', $inv) }}" data-confirm="حذف الفاتورة؟" class="inline">@csrf @method('DELETE')<button class="w-8 h-8 rounded-lg bg-red-100 text-red-700 hover:bg-red-200 transition-colors flex items-center justify-center"><svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button></form>@endif
                                    </div>
                                </td>
                            </tr>
                        @empty
                            ...
                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        @if($isFinAdmin)<form method="POST" action="{{ route('finance.fees.destroy', $fee) }}" data-confirm="حذف الرسم؟" class="inline">@csrf @method('DELETE')<button class="w-8 h-8 rounded-lg bg-red-100 text-red-700 hover:bg-red-200 transition-colors flex items-center justify-center"><svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button></form>@endif
                                    </div>
                                </td>
                            </tr>
